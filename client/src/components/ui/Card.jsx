    ...
    >
      ...
      <div className="flex flex-col gap-4 relative capitalize px-[10px] py-[20px] ">
        <div className="flex justify-start flex-col  gap-4 ">
          <h1 className="capitalize text-xl font-semibold ">{product.title}</h1>
        ...
        <div className="flex justify-between items-center ">
          ...
          className="bg-orange-500 px-2 py-2 text-xl rounded-full text-white hover:bg-orange-800 transition-all duraion-300">
            <svg
